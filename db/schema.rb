...
ActiveRecord::Schema.define(version: 2020_09_29_073626) do
  ...
  create_table "styles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "tops2_price"
    t.integer "tops3_price"
    t.integer "tops4_price"
    t.integer "tops5_price"
    t.integer "bottoms1_price", null: false
    t.integer "bottoms2_price"
    t.integer "shoes_price"
    t.integer "accessories1_price"
    t.integer "accessories2_price"
    t.integer "accessories3_price"
    t.integer "total_price", null: false
    t.bigint "supplier_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["supplier_id"], name: "index_styles_on_supplier_id"
  end
  ...
  add_foreign_key "styles", "suppliers"
end
